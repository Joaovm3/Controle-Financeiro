<?php
    ...
    include_once('../../controller/php/consulta_patrimonio.php');
?>
<!DOCTYPE html>
<html lang="pt-bt">
<head>
...
<body>
    ...
    <main id="global" class="container">
        ...
        <div class="container valor">
            <p>Saldo</p>
            <h1>R$<?php echo number_format($total_patrimonio,2,",",".");?></h1>
            <p>Patrimonial</p>
        </div>
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    echo '
                        <div class="container informations">
                            ...
                            <div class="container">
                                <a href="/app/acfinanceiro/model/php/deletar_patrimonio.php?id='.$row['id'].'&caracteristica='.$row['caracteristica'].'">Deletar '.$row['caracteristica'].'</a>
                            </div>
                        </div>
                    ';
                }
